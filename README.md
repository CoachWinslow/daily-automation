...
- **5:00–6:00 AM**: `morningMotivation()` — daily non-negotiables checklist (health, AWS study, career goals), delivered to Slack (`#enveniam-viam`), Discord, and Gmail.
- **9:00–10:00 AM**: `bilingualAWS()` — AWS cloud computing concept of the day, delivered in English and Spanish, to Slack (`#aws-cloud-eng-span`), Discord, and Gmail.
- **10:00–11:00 AM**: `morningTechnews()` — real-time tech news digest (SaaS, Cloud, Data Centers, Chip Makers), generated by Claude with live web search, delivered to Slack (`#tech-news`), Discord, and Gmail.
